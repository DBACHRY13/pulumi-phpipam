...
class SubnetArgs:
    def __init__(__self__, *,
                 section_id: pulumi.Input[int],
                 subnet_address: pulumi.Input[str],
        ...
        :param pulumi.Input[int] section_id: The ID of the section for this address in the
               PHPIPAM database.
        :param pulumi.Input[str] subnet_address: The network address of the subnet.
        :param pulumi.Input[int] subnet_mask: The subnet mask, in bits.
        :param pulumi.Input[bool] allow_ip_requests: `true` if the subnet allows IP requests in
               PHPIPAM.
        :param pulumi.Input[bool] create_ptr_records: `true` if PTR records are created for
        ...
        :param pulumi.Input[str] description: The description set for the subnet.
        :param pulumi.Input[bool] display_hostnames: `true` if hostnames are displayed instead of
               IP addresses in the address listing for this subnet.
        :param pulumi.Input[bool] host_discovery_enabled: `true` if this subnet is included in
               new host scans.
        :param pulumi.Input[bool] include_in_ping: `true` if this subnet is included in ping
               probes.
        :param pulumi.Input[bool] is_folder: `true` if this subnet is a folder and not an actual
               subnet.
        :param pulumi.Input[bool] is_full: `true` if the subnet has been marked as full.
        :param pulumi.Input[int] linked_subnet_id: The ID of the linked subnet in the PHPIPAM
               database.
        :param pulumi.Input[int] location_id: The ID of the location for this subnet.
        :param pulumi.Input[int] master_subnet_id: The ID of the parent subnet for this subnet
               in the PHPIPAM database.
        :param pulumi.Input[int] nameserver_id: The ID of the nameserver used to assign PTR
               records for this subnet.
        :param pulumi.Input[bool] resolve_dns: `true` if enabled resolving of DNS names.
        :param pulumi.Input[int] scan_agent_id: The ID of the ping scan agent that is used for
               this subnet.
        :param pulumi.Input[bool] show_name: `true` if the subnet name is are shown in the
               section, instead of the network address.
        :param pulumi.Input[int] utilization_threshold: The subnet's utilization threshold.
        :param pulumi.Input[int] vlan_id: The ID of the VLAN for this subnet in the PHPIPAM
               database.
        :param pulumi.Input[int] vrf_id: The ID of the VRF for this subnet in the PHPIPAM
               database.
        """
    ...
    def section_id(self) -> pulumi.Input[int]:
        """
    ...
    @section_id.setter
    def section_id(self, value: pulumi.Input[int]):
        pulumi.set(self, "section_id", value)

    @property
    @pulumi.getter(name="subnetAddress")
    def subnet_address(self) -> pulumi.Input[str]:
        """
    ...
    def subnet_address(self, value: pulumi.Input[str]):
...
class _SubnetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] nameserver_id: The ID of the nameserver used to assign PTR
               records for this subnet.
        :param pulumi.Input[str] permissions: A JSON representation of the permissions associated with this
               subnet.
        :param pulumi.Input[bool] resolve_dns: `true` if enabled resolving of DNS names.
        :param pulumi.Input[int] scan_agent_id: The ID of the ping scan agent that is used for
               this subnet.
        ...
        :param pulumi.Input[bool] show_name: `true` if the subnet name is are shown in the
               section, instead of the network address.
        :param pulumi.Input[str] subnet_address: The network address of the subnet.
        :param pulumi.Input[int] subnet_id: The ID of the subnet in the PHPIPAM database.
        :param pulumi.Input[int] subnet_mask: The subnet mask, in bits.
        :param pulumi.Input[int] utilization_threshold: The subnet's utilization threshold.
        :param pulumi.Input[int] vlan_id: The ID of the VLAN for this subnet in the PHPIPAM
               database.
...
class Subnet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if subnet_address is None and not opts.urn:
            ...
            __props__.__dict__["parent_subnet_id"] = None
