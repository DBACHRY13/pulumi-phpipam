...
class AddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] subnet_id: The database ID of the subnet this IP address
               belongs to.
        :param pulumi.Input[Mapping[str, Any]] custom_fields: A key/value map of custom fields for this address.
        ...
        :param pulumi.Input[str] description: The description provided to this IP address.
        :param pulumi.Input[int] device_id: The ID of the associated device in the PHPIPAM
               database.
        :param pulumi.Input[bool] exclude_ping: `true` if this address is excluded from ping
               probes.
        :param pulumi.Input[str] hostname: The hostname supplied to this IP address.
        :param pulumi.Input[str] ip_address: The IP address to reserve.
        :param pulumi.Input[bool] is_gateway: `true` if this IP address has been designated as a
               gateway.
        :param pulumi.Input[str] mac_address: The MAC address provided to this IP address.
        :param pulumi.Input[str] note: The note supplied to this IP address.
        :param pulumi.Input[str] owner: The owner name provided to this IP address.
        :param pulumi.Input[int] ptr_record_id: The ID of the associated PTR record in the
               PHPIPAM database.
        :param pulumi.Input[bool] skip_ptr_record: `true` if PTR records are not being created
               for this IP address.
        :param pulumi.Input[int] state_tag_id: The tag ID in the database for the IP address'
        ...
        :param pulumi.Input[str] switch_port_label: A string port label that is associated with
               this address.
        """
        ...
        if remove_dns_on_delete is not None:
            pulumi.set(__self__, "remove_dns_on_delete", remove_dns_on_delete)
    ...
    def remove_dns_on_delete(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "remove_dns_on_delete")

    @remove_dns_on_delete.setter
    def remove_dns_on_delete(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "remove_dns_on_delete", value)
...
class _AddressState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] address_id: The ID of the IP address in the PHPIPAM database.
        :param pulumi.Input[Mapping[str, Any]] custom_fields: A key/value map of custom fields for this address.
        ...
        :param pulumi.Input[int] device_id: The ID of the associated device in the PHPIPAM
               database.
        :param pulumi.Input[str] edit_date: The last time this resource was modified.
        :param pulumi.Input[bool] exclude_ping: `true` if this address is excluded from ping
               probes.
        :param pulumi.Input[str] hostname: The hostname supplied to this IP address.
        :param pulumi.Input[str] ip_address: The IP address to reserve.
        :param pulumi.Input[bool] is_gateway: `true` if this IP address has been designated as a
               gateway.
        :param pulumi.Input[str] last_seen: The last time this IP address answered ping probes.
        :param pulumi.Input[str] mac_address: The MAC address provided to this IP address.
        :param pulumi.Input[str] note: The note supplied to this IP address.
        :param pulumi.Input[str] owner: The owner name provided to this IP address.
        :param pulumi.Input[int] ptr_record_id: The ID of the associated PTR record in the
...
class Address(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["remove_dns_on_delete"] = remove_dns_on_delete
