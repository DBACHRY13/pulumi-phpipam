module github.com/DBACHRY13/pulumi-phpipam/provider
...
require (
	github.com/lord-kyron/terraform-provider-phpipam v1.6.2
...
require (
	...
	github.com/pavel-z1/phpipam-sdk-go v0.1.9 // indirect
