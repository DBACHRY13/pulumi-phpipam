...
import (
	...
	phpipam "github.com/lord-kyron/terraform-provider-phpipam/plugin/providers/phpipam"

	"github.com/DBACHRY13/pulumi-phpipam/provider/pkg/version"
)
...
const (
	...
	mainPkg = "phpipam"
	// modules:
	mainMod = "index" // the phpipam module
)

//go:embed cmd/pulumi-resource-phpipam/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-phpipam/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-phpipam/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "phpipam", phpipam.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-phpipam/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(phpipam.Provider()),
		...
		Keywords:   []string{"DHW", "phpipam", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/DBACHRY13/pulumi-phpipam/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("phpipam_", mainMod,
