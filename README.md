...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `phpipam` with the `NAME` of your provider.
   - find and replace all instances of the boilerplate `DHW` with the `ORG` of your provider.
   - replace all instances of the `github.com/DBACHRY13/pulumi-phpipam` repository with the `REPOSITORY` location
...
- binary: pulumi-resource-phpipam
  ...
  ignore: []
  ldflags:
  - -X github.com/DBACHRY13/pulumi-phpipam/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-phpipam_darwin_amd64_v1
│   └── pulumi-resource-phpipam
├── pulumi-phpipam_darwin_arm64
│   └── pulumi-resource-phpipam
├── pulumi-phpipam_linux_amd64_v1
│   └── pulumi-resource-phpipam
├── pulumi-phpipam_linux_arm64
│   └── pulumi-resource-phpipam
├── pulumi-phpipam_windows_amd64_v1
│   └── pulumi-resource-phpipam.exe
└── pulumi-phpipam_windows_arm64
    └── pulumi-resource-phpipam.exe
```
